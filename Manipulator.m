classdef Manipulator
    ...
    methods
        function obj = Manipulator(DH,mass,centerOfMass,inertia,rho,gravity_vector,isSym)
            ...
            tempListLink = cell(1,N);
            tempListJoint = cell(1,N);
            for i = 1:N,
                ...
                tempListLink{i} = link;
                tempListJoint{i} = joint;
            end
            
            obj.ListLink = tempListLink;
            obj.ListJoint = tempListJoint;
